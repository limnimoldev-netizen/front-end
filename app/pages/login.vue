<template>
  ...
  <div class="min-h-screen flex font-['Plus_Jakarta_Sans',sans-serif] selection:bg-indigo-500/30">
    ...
    <div class="hidden lg:block lg:flex-1 relative overflow-hidden bg-slate-950">
      <img 
        src="https://online.maryville.edu/wp-content/uploads/sites/97/2023/09/hr-team.jpg" 
        alt="Abstract Network"
        class="absolute inset-0 w-full h-full object-cover opacity-40 hover:scale-105 transition-transform duration-1000"
      />
      
      <div class="absolute inset-0 flex flex-col justify-end p-20">
        <div class="w-16 h-1 bg-indigo-500 mb-8 rounded-full"></div>
        <h2 class="text-6xl font-extrabold text-white leading-[1.1] mb-6 uppercase tracking-tighter">
...
<style scoped>
/* Smooth slide-up animation for the alert message */
